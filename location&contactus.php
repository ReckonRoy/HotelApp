                            ...
                            <form action="index.php">
                                <div class="row contact_form">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text"><br>
                                        <label>Your E - Mail <span>*</span></label><br>
                                        <input type="text"><br>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="col-md-8 col-xs-10" style="padding-left:0;">
                                        <a href="tel:+27 21 999 0005">+27 21 999 0005</a><br>
                                        <a href="tel:+27 21 999 0006">+27 21 999 0006</a>
                                    </div>
                                </li>
                               <li>
                                ...
                                <li>
                                    ...
                                    <div class="col-md-8 col-xs-10">
                                        <a href="siya:info.bookit@bookingapp.com.Com">Info@bookitapp.Com</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
