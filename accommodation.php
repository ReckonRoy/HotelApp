        ...
        <section class="roomArea">
            <div class="container">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single_room_item">
                                <div class="room_photo" >
                                    ...
                                    <div class="photo_cap">
                                        <a href="img/facilities.jpg" class="lightbox" data-gall="gall-room"><i class="glyphicon glyphicon-search"></i></a>
                                    </div>
                                </div>
                                <div class="room_title">
                                    <h2>Start From R 80.00 / Night</h2>
                                </div>
                                <div class="ttl-link">
                                  <a href="single-room.php">Check Details <img src="img/icon_calendar.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single_room_item">
                                <div class="room_photo">
                                    ...
                                    <div class="photo_cap">
                                        <a href="img/grandRoom.jpg" class="lightbox" data-gall="gall-room"><i class="glyphicon glyphicon-search"></i></a>
                                    </div>
                                </div>
                                <div class="room_title">
                                    <h2>Start From R 199.00 / Night</h2>
                                </div>
                                <div class="ttl-link">
                                        <a href="single-room.php">Check Details <img src="img/icon_calendar.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-md-offset-0 col-sm-offset-3">
                            <div class="single_room_item">
                                <div class="room_photo">
                                    ...
                                    <div class="room-title">
                                        <h3>Grand Superior Room</h3>
                                    </div>
                                    <div class="photo_cap">
                                        <a href="img/hotel_room_photo_3.jpg" class="lightbox" data-gall="gall-room"><i class="glyphicon glyphicon-search"></i></a>
                                    </div>
                                </div>
                                <div class="room_title">
                                    <h2>Start From R 285.00 / Night</h2>
                                </div>
                                <div class="ttl-link">
                                        <a href="single-room.php">Check Details <img src="img/icon_calendar.png" alt=""></a>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="view_all">
                            <a class="rm_btn btn-primary" role="button" href="rooms.php">View All rooms</a>
                        </div>
                    </div>
                </div>
            </div>
